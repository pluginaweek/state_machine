...
module StateMachine
  ...
  class Transition
    ...
    private
      ...
      def pause
        raise ArgumentError, 'around_transition callbacks cannot be called in multiple execution contexts in java implementations of Ruby. Use before/after_transitions instead.' if StateMachine.callcc_unsupported?
