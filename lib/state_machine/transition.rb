module PluginAWeek #:nodoc:
  module StateMachine
    ...
    class Transition
      ...
      # == Example
      # 
      #   machine = PluginAWeek::StateMachine.new(Object, 'state')
      #   transition = PluginAWeek::StateMachine::Transition.new(Object.new, machine, 'enable, 'disabled', 'enabled')
      ...
      #   
      #   vehicle = Vehicle.new
      #   transition = PluginAWeek::StateMachine::Transition.new(vehicle, machine, :turn_on, 'off', 'on')
