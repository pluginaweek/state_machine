...
If you are using this library as a gem, the following must be added to your
application's Rakefile in order for the above task to work:

  load("#{Gem.searcher.find('state_machine').full_gem_path}/tasks/state_machine.rake")
