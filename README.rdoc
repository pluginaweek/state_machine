...
like so:
  ...
  vehicle.fire_events(:shift_down, :close_hood)   # => true
  vehicle.state_name                              # => :first_gear
  vehicle.hood_state_name                         # => :closed
  
  vehicle.fire_events!(:ignite, :close_hood)      # => StateMachine::InvalidTransition: Cannot run events in parallel: ignite, close_hood
