...
like so:
  ...
  vehicle.alarm_disabled?         # => true
  vehicle.alarm_enabled?          # => false
  ...
  vehicle.fire_events!(:ignite, :enable_alarm)    # => StateMachine::InvalidTransition: Cannot run events in parallel: ignite
