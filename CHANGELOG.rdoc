...
* Add support for dynamic to states in transitions
...
* Add the ability to skip state change actions during a transition
...
* Use a class containing the transition result in callbacks, rather than an ordered list of each individual attribute
