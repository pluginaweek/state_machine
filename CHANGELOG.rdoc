...
* Add #state_transitions for getting the list of transitions that can be run on an object
* Add #state_events for getting the list of events that can be fired on an object
